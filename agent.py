...
def _build_realtime_llm():
    ...
    turn_detection = TurnDetection(
        type="server_vad",
        threshold=_get_float_env("OPENAI_REALTIME_TURN_THRESHOLD", 0.38),
        prefix_padding_ms=_get_int_env("OPENAI_REALTIME_PREFIX_PADDING_MS", 200),
        silence_duration_ms=_get_int_env("OPENAI_REALTIME_SILENCE_DURATION_MS", 160),
...
def _build_vad():
    ...
    return silero.VAD.load(
        min_speech_duration=_get_float_env("VAD_MIN_SPEECH_DURATION", 0.03),
        min_silence_duration=_get_float_env("VAD_MIN_SILENCE_DURATION", 0.20),
        prefix_padding_duration=_get_float_env("VAD_PREFIX_PADDING_DURATION", 0.20),
